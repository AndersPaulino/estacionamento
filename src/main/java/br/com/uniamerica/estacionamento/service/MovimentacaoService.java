...
public class MovimentacaoService {
    ...
    public void cadastrar(Movimentacao movi){
        ...
        Assert.isTrue(movi.getDataEntrada() != null, "Entradada nao informado");
    ...
    public void editar(final Long id, Movimentacao movi){
        ...
        Assert.isTrue(movi.getCondutor() != null, "Condutor nao informada");
        Assert.isTrue(movi.getDataEntrada() != null, "Entradada nao informado");
        Assert.isTrue(movi.getDataSaida() != null, "Saida nao informada");
    ...
    public void horaFinal(final Long id){
        ...
        Duration duracaoHora = Duration.between(moviBanco.getDataEntrada(), saida);
       ...
       /* moviBanco.setTempo(duracaoHora.toMinutesPart());
